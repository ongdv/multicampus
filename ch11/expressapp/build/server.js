...
app.get('/', function (req, res) {
    ...
    var html = (0, _server.renderToString)(_react2.default.createElement(_App2.default, { title: 'React SSR Test!!' }));
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.state = {
            members: [{ id: 1, name: "홍길동" }, { id: 2, name: "이몽룡" }, { id: 3, name: "성춘향" }, { id: 4, name: "박문수" }, { id: 5, name: "이이이" }]
        };
        return _this;
    }
    ...
    _createClass(App, [{
        ...
        value: function render() {
            var list = this.state.members.map(function (member) {
